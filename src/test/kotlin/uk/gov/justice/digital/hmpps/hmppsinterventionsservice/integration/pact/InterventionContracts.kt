...
class InterventionContracts(
  ...
  fun createInterventionWithKnownId() {
    // create an intervention with the known id
  ...
  fun createInterventionWithRequestedId() {
    // create an intervention with the requested id
  ...
  fun createInterventionForDefaultSPUserContractScope() {
    // create an intervention for the default SP users contract scope
