...
import uk.gov.justice.digital.hmpps.hmppsinterventionsservice.jpa.entity.InterventionHelper.Companion.sampleContract
import uk.gov.justice.digital.hmpps.hmppsinterventionsservice.jpa.entity.InterventionHelper.Companion.sampleIntervention
import uk.gov.justice.digital.hmpps.hmppsinterventionsservice.jpa.entity.InterventionHelper.Companion.sampleNPSRegion
import uk.gov.justice.digital.hmpps.hmppsinterventionsservice.jpa.entity.InterventionHelper.Companion.sampleServiceCategory
import uk.gov.justice.digital.hmpps.hmppsinterventionsservice.jpa.entity.InterventionHelper.Companion.sampleServiceProvider
...
class InterventionServiceTest @Autowired constructor(
  ...
  @Test
  fun `create and persist intervention`() {
    ...
    assertThat(savedIntervention!!.id).isNotNull
    assertThat(savedIntervention.createdAt).isNotNull
  }
  ...
  fun `create and persist interventions against same contract`() {
    ...
    interventionService.createIntervention(intervention2)
    entityManager.flush()
