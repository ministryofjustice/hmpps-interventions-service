...
import uk.gov.justice.digital.hmpps.hmppsinterventionsservice.jobs.scheduled.transferreferrals.TransferReferralsReader
...
internal class TransferReferralsReaderTest @Autowired constructor(
  ...
  fun createTransferCaseNote(referral: Referral): CaseNote = setupAssistant.createCaseNote(
    referral = referral,
    subject = "Irrelevant",
