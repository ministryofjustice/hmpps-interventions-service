...
class ReferralContracts(private val setupAssistant: SetupAssistant) {
  ...
  fun createTheAssignedReferral() {
    // create the assigned referral
  ...
  fun createReferralWithEndRequest() {
    // create a referral with an end request
  ...
  fun createAnEndedReferral() {
    // create an ended referral
  ...
  fun createReferralWithoutActionPlan() {
    // create an assigned referral with no action plan
  ...
  fun createSentReferralWithAssignedUser() {
    // create a sent referral with ID 4afb07a0-e50b-490c-a8c1-c858d5a1e912 with an assigned user
  ...
  fun createSentReferralWithoutAssignedUser() {
    // create a sent referral with ID dc94fbd6-354b-4edc-863b-cffc8358f1ec without an assigned user
    setupAssistant.createAssignedReferral(
  ...
  fun createSentreferralsInVaryingStates() {
    // create several sent referrals of varing states of completion
    // assigned
  ...
  fun createNewDraftReferralForDeliusUser() {
    // create a new draft referral for 'deliusUser' with a specific createdAt timestamp and CRN
    setupAssistant.createDraftReferral(
  ...
  fun createWomensServiceReferal() {
    // create a new draft referral with women's service type and 'HARMONY_LIVING' service provider
  ...
  fun createSentReferralWithExpectedId81d754aa() {
    // create sent referral 81d754aa
  ...
  fun createReferralWithExpectedId2a67075ad() {
    // create referral with 2a67075a id
    val referral = setupAssistant.createDraftReferral(
  ...
  fun gotChangeLogEntries() {
    // got change log entires successfully
  ...
  fun createDraftreferralWithDesiredOutcomesAndServiceCategories() {
