...
class EndOfServiceReportContracts(private val setupAssistant: SetupAssistant) {
  ...
  fun createReferralWithEosr() {
    // create referral with eosr
  ...
  fun createReferralReadyForEosr() {
    // create the referral ready to have an eosr created
  ...
  fun createEosrWithGivenId() {
    // create the eosr with id 31ad504a-1827-46e4-ac95-68b4e1256659
  ...
  fun createEosrForReferralWithDesiredOutcome() {
    // create the eosr against a referral with a desired outcome
  ...
  fun createTheEosrWithGivenId() {
    // create the eosr with id c3239695-b258-4ac6-9478-cb6929668aaa
