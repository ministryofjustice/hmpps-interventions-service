...
class ActionPlanContracts(private val setupAssistant: SetupAssistant) {
  ...
  fun createAnEmptyActionPlan() {
    // create an empty action plan with 1 appointment that has had attendance recorded
  ...
  fun createSubmittedActionPlan() {
    // create a submitted action plan with 3 appointments
    val referral = setupAssistant.createSentReferral()
  ...
  fun createActionPlanThatsSubmitted() {
    // create an action plan that has been submitted
    setupAssistant.createActionPlan(
  ...
  fun createActionPlanThatsApproved() {
    // create an action plan that has been approved
    setupAssistant.createActionPlan(
  ...
  fun createSentReferralWithActionPlan() {
    // create sent referral 8b423e17 with action plan
  ...
  fun createDraftActionPlanNotSubmitted() {
    // create a an draft plan with activities and has not been submitted
  ...
  fun createSentWithIdInContract() {
    // create a sent referral with the id specified in the contract
  ...
  fun createAnEmptyDraftPlan() {
    // create a an empty draft plan
    setupAssistant.createActionPlan(id = UUID.fromString("dfb64747-f658-40e0-a827-87b4b0bdcfed"))
  }
  ...
  fun createDraftPlanWithActivities() {
    // create a an draft plan with activities
    val referral = setupAssistant.createSentReferral()
  ...
  fun createAnActionPlanWithAttendedAppointment() {
    // create an action plan with an appointment with recorded attendance and behaviour
    val referral = setupAssistant.createSentReferral()
    setupAssistant.createActionPlan(
  ...
  fun createTwoActionPlans() {
    // create two action plans for a referral
