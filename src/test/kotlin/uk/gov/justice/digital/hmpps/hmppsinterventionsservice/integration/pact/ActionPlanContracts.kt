...
class ActionPlanContracts(private val setupAssistant: SetupAssistant) {
  ...
  fun `create an empty draft plan with 2 2 hours appointments`() {
    val referral = setupAssistant.createSentReferral()
    setupAssistant.createActionPlan(id = UUID.fromString("345059d4-1697-467b-8914-fedec9957279"), numberOfSessions = 2, referral = referral)
    ...
    setupAssistant.createActionPlanSession(1, 120, OffsetDateTime.parse("2021-05-13T12:30:00+00:00"), appointmentDeliveryType = AppointmentDeliveryType.IN_PERSON_MEETING_OTHER, appointmentDeliveryAddress = appointmentDeliveryAddress, appointmentSessionType = AppointmentSessionType.GROUP, referral = referral)
    setupAssistant.createActionPlanSession(2, 120, OffsetDateTime.parse("2021-05-13T12:30:00+00:00"), appointmentDeliveryType = AppointmentDeliveryType.IN_PERSON_MEETING_OTHER, appointmentDeliveryAddress = appointmentDeliveryAddress, appointmentSessionType = AppointmentSessionType.GROUP, referral = referral)
  }
