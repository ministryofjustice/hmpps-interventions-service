...
class PerformanceReportProcessor(
  ...
  override fun process(referral: Referral): PerformanceReportData {
    ...
    return PerformanceReportData(
      ...
      dateSupplierAssessmentFirstCompleted = saa?.firstCompletedAppointment?.appointmentTime,
      ...
      numberOfSessionsAttended = approvedActionPlan?.let { actionPlanService.getAllCompletedAppointments(it).size },
