  ...
  @Query(
    ...
    """WITH attended_sessions AS (
        ...
        select
            ...
            cast(apds.submitted_at as TIMESTAMP WITH TIME ZONE) AS dateFirstActionPlanSubmitted,
            cast(apda.approved_at as TIMESTAMP WITH TIME ZONE) AS dateOfFirstActionPlanApproval,
            ...
            apda.number_of_sessions AS countOfSessionsExpected,
            ...
            cast(ref.concluded_at as TIMESTAMP WITH TIME ZONE) AS concludedAt
                from referral ref
                    ...
                    left join action_plans_dates apda ON (apda.referral_id = ref.id and apda.approved_at_desc_seq = 1)
