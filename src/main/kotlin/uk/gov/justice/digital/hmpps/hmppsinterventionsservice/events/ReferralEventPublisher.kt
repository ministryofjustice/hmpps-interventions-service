...
enum class ReferralEventType {
  SENT, ASSIGNED, CANCELLED, PREMATURELY_ENDED, COMPLETED, DETAILS_AMENDED, COMPLEXITY_LEVEL_AMENDED, NEED_AND_REQUIREMENT_AMEND
}
...
class ReferralEventPublisher(
  ...
  fun referralNeedAndRequirementsChangedEvent(referral: Referral) {
    applicationEventPublisher.publishEvent(ReferralEvent(this, ReferralEventType.NEED_AND_REQUIREMENT_AMEND, referral, getSentReferralURL(referral)))
  }
