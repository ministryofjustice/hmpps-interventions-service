...
data class ChangelogValuesDTO(
  ...
  companion object {
    private val amendTopicDescription: Map<AmendTopic, String> = mapOf(
      ...
      AmendTopic.REASON_FOR_REFERRAL to "Reason for this referral and referral details has changed",
      AmendTopic.REASON_FOR_REFERRAL_FURTHER_INFORMATION to "Further information for this referral has changed",
      ...
      AmendTopic.PROBATION_PRACTITIONER_TEAM_PHONE_NUMBER to "Team phone number has changed",
    )
