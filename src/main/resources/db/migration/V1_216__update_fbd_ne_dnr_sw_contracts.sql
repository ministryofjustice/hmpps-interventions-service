update intervention set description='Services are available for all adult males on probation either on a Community Sentence or Suspended Sentence Order and subject to a Rehabilitation Activity Requirement (RAR) whereby a specified number of RAR Activity Days will be allocated, pre-release to people who are sentenced or released on licence and post-sentence supervision.
                                     ...
                                     • The person referred is supported to complete tasks that they would not otherwise be able to do whilst being in custody e.g. support with banking or debt management' where id = '5575e6bf-0eac-4da7-be1c-5ec89a9bbc3b';