...
dependencies {
  ...
  // aws
  implementation("software.amazon.awssdk:sns:2.19.1")
  implementation("software.amazon.awssdk:s3:2.19.0")

  // security
  implementation("org.springframework.boot:spring-boot-starter-webflux")
  implementation("org.springframework.boot:spring-boot-starter-oauth2-resource-server")
  implementation("org.springframework.boot:spring-boot-starter-oauth2-client")
  implementation("com.nimbusds:oauth2-oidc-sdk:10.5")
  ...
  testImplementation("au.com.dius.pact.provider:junit5spring:4.4.3")
