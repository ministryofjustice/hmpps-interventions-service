...
dependencies {
  ...
  implementation("io.sentry:sentry-spring-boot-starter:7.22.2")
  ...
  // aws
  implementation("software.amazon.awssdk:sns:2.31.1")
  ...
  implementation("org.hibernate:hibernate-core:6.6.10.Final")
