...
dependencies {
  ...
  implementation("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.18.0") // also needed runtime for AppInsights
  ...
  runtimeOnly("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.18.0") // needed for OffsetDateTime for AppInsights
  ...
  // aws
  implementation("software.amazon.awssdk:sns:2.28.26")
  implementation("software.amazon.awssdk:s3:2.28.25")
  implementation("software.amazon.awssdk:sts:2.28.25")
