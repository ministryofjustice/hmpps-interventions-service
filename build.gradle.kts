...
dependencies {
  ...
  implementation("io.sentry:sentry-spring-boot-starter:7.19.0")
  ...
  // aws
  implementation("software.amazon.awssdk:sns:2.29.32")
  implementation("software.amazon.awssdk:s3:2.29.32")
  implementation("software.amazon.awssdk:sts:2.29.32")
