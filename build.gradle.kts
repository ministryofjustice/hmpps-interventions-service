...
dependencies {
  ...
  implementation("io.sentry:sentry-spring-boot-starter:8.7.0")
  ...
  // aws
  implementation("software.amazon.awssdk:sns:2.31.20")
  implementation("software.amazon.awssdk:s3:2.31.19")
  implementation("software.amazon.awssdk:sts:2.31.19")
