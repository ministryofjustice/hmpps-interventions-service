...
dependencies {
  ...
  implementation("io.sentry:sentry-spring-boot-starter:7.21.0")
  implementation("io.sentry:sentry-logback:7.21.0")
  ...
  // aws
  implementation("software.amazon.awssdk:sns:2.30.11")
