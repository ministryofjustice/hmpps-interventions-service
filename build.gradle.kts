...
dependencies {
  ...
  implementation("io.sentry:sentry-spring-boot-starter:7.20.1")
  ...
  // aws
  implementation("software.amazon.awssdk:sns:2.30.6")
  ...
  implementation("com.nimbusds:oauth2-oidc-sdk:11.21.2")
