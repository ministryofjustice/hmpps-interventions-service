FROM --platform=${BUILDPLATFORM:-linux/amd64} eclipse-temurin:17.0.8_7-jre-focal AS builder
...
# ---
FROM --platform=${BUILDPLATFORM:-linux/amd64} eclipse-temurin:17.0.8_7-jre-focal AS final
