FROM --platform=${BUILDPLATFORM:-linux/amd64} eclipse-temurin:17.0.9_9-jre-focal AS builder
...
# ---
FROM --platform=${BUILDPLATFORM:-linux/amd64} eclipse-temurin:17.0.9_9-jre-focal AS final
